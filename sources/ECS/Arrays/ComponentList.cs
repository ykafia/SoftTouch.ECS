...
public class ComponentList<T> : ComponentList, IList<T>, IReadOnlyList<T>, ICollection<T>, IEnumerable<T>, IEnumerable
where T : struct
{
    // Fields
    ...
    public Span<T> Span => Items.AsSpan();
    ...
    public ComponentList(IEnumerable<T> collection)
    {
    ...
    public override ComponentList New() => new ComponentList<T>();
    public override void TransferTo(ComponentList l, int i)
    {
        if(l is ComponentList<T> lt)
            TransferTo(lt, i);
        else
            throw new Exception("Wrong component type");
    }
    public void TransferTo(ComponentList<T> l, int i)
    {
        var tmp = Items[i];
        RemoveAt(i);
        l.Add(tmp);
    ...
    public ComponentList<T> FindAll(Predicate<T> match)
    {
    ...
    public ComponentList<T> GetRange(int index, int count)
    {
        var list = new ComponentList<T>(count);
    ...
    {
        private readonly ComponentList<T> list;
        private int index;
        private T current;
